...
class ModelWeightsConfig(BaseSettings):
    ...
    def download_missing_weights(self, weights_dir: Optional[Union[str, Path]] = None, force: bool = False) -> bool:
        """
    ...
    def check_weights_availability(self, weights_dir: Optional[Union[str, Path]] = None) -> Dict[str, bool]:
        """
